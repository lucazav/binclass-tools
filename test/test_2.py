...
from bctools import curve_PR_plot

import unittest
from unittest.mock import patch

class Test_Amounts_Cost(unittest.TestCase):
    def test_curve_PR_plot(self):
        ...
        self.assertAlmostEqual(area_under_PR,0.9021518156511643 , places=3)


        # If something breaks inside this function, it will not be called and the test will fail.
        with patch("bctools.curve_PR_plot") as show_patch:
            curve_PR_plot(true_y = y_test, predicted_proba = test_predicted_proba)    
